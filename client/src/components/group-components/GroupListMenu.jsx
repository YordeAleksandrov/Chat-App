...
const GroupsListMenu = () => {
  ...
  return (
    <div className={classes.groupSection}>
      {groupInvites.length>0 && <h2 className={classes.groupTitle}>Invites</h2>}
      ...
      <h2 className={classes.groupTitle}>Groups</h2>
      ...
      <div className={classes.buttonContainer}>
        ...
        onClick={()=>nav('/join-group')}>Join</Button>
        <Button className={classes.button}
      ...
      >
        <Box className={classes.modal}>
          <Avatar
            ...
            sx={{ width: 250, height: 250, marginTop: '10px', cursor: 'pointer' }}
          />
          <div>
            <TextField
            ...
            />
            {error.type && <h4 style={{ marginTop: '2px', marginBottom: '0px', color: 'red' }}>{error.type}</h4>}
          </div>
          <TextField
